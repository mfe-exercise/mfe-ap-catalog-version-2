...
import { EventNameEnum, FilterItemsEnum } from '../../../utils/constants';
...
const useCatalog = () => {
  ...
  const searchData = useCallback(() => {
    ...
    window.dispatchEvent(new CustomEvent(EventNameEnum.SEARCH, {
      detail: { query: search }
    }));
